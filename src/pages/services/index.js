...
export default function Services() {
    ...
    const services = [
        {
            icon: <Scissors className={`w-10 h-10 ${theme === "dark" ? "text-amber-400" : "text-amber-500"}`} />,
        ...
        {
            icon: <Sparkles className={`w-10 h-10 ${theme === "dark" ? "text-amber-400" : "text-amber-500"}`} />,
        ...
        {
            icon: <Clock className={`w-10 h-10 ${theme === "dark" ? "text-amber-400" : "text-amber-500"}`} />,
            title: "Expressklippning",
            description: "För dig som är på språng men ändå vill ha en snygg och fräsch frisyr på kort tid.",
        },
        {
            icon: <Users className={`w-10 h-10 ${theme === "dark" ? "text-amber-400" : "text-amber-500"}`} />,
            title: "Barnklippning",
            description:
