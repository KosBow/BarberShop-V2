  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          En modern barbershop i Linköping med fokus på stil, kvalitet och
          upplevelse.
        </p>
      ...
      <section className="container mx-auto max-w-6xl px-4 pb-20 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <motion.div {...fadeUp(0.4)} className="space-y-5">
          ...
          >
            AeA Barbershop är mer än bara en plats för klippning – det är en
            upplevelse. Vi tror att en bra frisyr handlar lika mycket om känslan
            som resultatet. Hos oss möter du barberare med passion för
          ...
          >
            ...
            en helt ny stil, ser vi till att du lämnar salongen med förnyat
          ...
          >
            <h3 className="text-lg font-semibold mb-2 text-amber-400">Vårt löfte till dig</h3>
            <ul
